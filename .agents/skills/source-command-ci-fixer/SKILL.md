---
name: "source-command-ci-fixer"
description: "CI and local lint/test fixer for the current PR branch. Use when gh pr checks or GitHub Actions are red and you want isolated log digging plus a minimal fix without distracting the parent coordinator."
---

# source-command-ci-fixer

Use this skill when the user asks to run the migrated source command `ci-fixer`.
