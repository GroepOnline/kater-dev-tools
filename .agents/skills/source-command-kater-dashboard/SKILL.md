---
name: "source-command-kater-dashboard"
description: "Verify the Kater web dashboard and REST API surfaces on :9091. Use for dashboard hydration, /api/status, telemetry UI, or when REST checks matter but full MCP e2e is out of scope."
---

# source-command-kater-dashboard

Use this skill when the user asks to run the migrated source command `kater-dashboard`.
