---
name: "source-command-kater-e2e"
description: "End-to-end gateway proof: REST, MCP SSE initialize/tools, WebSocket handshake. Use for e2e-mcp.sh, prove MCP works, or post-change gateway validation while the server is running."
---

# source-command-kater-e2e

Use this skill when the user asks to run the migrated source command `kater-e2e`.
