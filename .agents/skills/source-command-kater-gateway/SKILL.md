---
name: "source-command-kater-gateway"
description: "Start, configure, and verify the Kater MCP gateway locally or in cloud. Use for kater serve, kater up, gateway health, port wiring, or when an agent must prove the gateway works without adapter secrets."
---

# source-command-kater-gateway

Use this skill when the user asks to run the migrated source command `kater-gateway`.
