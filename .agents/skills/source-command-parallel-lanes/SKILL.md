---
name: "source-command-parallel-lanes"
description: "Dispatch parallel Codex subagents with disjoint file scopes (~4 lanes) and a coordinator integrate step. Use for multi-file refactors, spawn parallel agents, or when AGENTS.md parallel rule applies."
---

# source-command-parallel-lanes

Use this skill when the user asks to run the migrated source command `parallel-lanes`.
