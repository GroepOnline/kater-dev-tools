---
name: "source-command-poteto-mode"
...
# source-command-poteto-mode

Use this skill when the user asks to run the migrated source command `poteto-mode`.
...
Do not copy playbooks into this repo. Do not use Codex's built-in babysit for PR status.
