...
| Branch | Evidence | Tag |
| --- | --- | --- |
| `docs/udo-full-use-runbook` | Content sanitized and landed via #76 as `docs/ops/kater-private-overlay-runbook.md`. Branch tip still carries internal refs (Notion URL, Linear CHE-649/659/664), so it must never land as-is. | `archive/20260912/udo-full-use-runbook` |
