...
class AutomationEngine:
    ...
    def upsert(
        ...
        *,
        ...
        Parameters:
            id (str | None): Identifier of the automation to update; a new identifier is generated
                when omitted.
    ...
    def run_now(self, automation_id: str, *, force: bool = False) -> AutomationRunResult:
        ...
        Raises:
            ...
            ValueError: If the automation is disabled without forcing execution or is already
                running.
        """
        with self._lock:
    ...
    def _execute(self, automation: Automation, *, ran_at: float) -> AutomationRunResult:
        ...
        Returns:
            AutomationRunResult: Execution status, details, error information, duration, and
                timestamp.
        """
