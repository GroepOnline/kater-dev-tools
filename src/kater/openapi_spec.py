...
def _build_paths() -> dict[str, Any]:
    ...
    paths["/studio"] = {
        "get": {
            "summary": "Kater Studio",
            "responses": {"200": {"description": "Studio HTML.", "content": _HTML}},
        }
    }
    paths["/studio/assets/studio.js"] = {
        "get": {
            "summary": "Kater Studio JavaScript asset",
            "responses": {
                "200": {"description": "Studio JavaScript bundle.", "content": _JAVASCRIPT}
            },
        }
    }
    paths["/studio/assets/studio.css"] = {
        "get": {
            "summary": "Kater Studio CSS asset",
            "responses": {"200": {"description": "Studio stylesheet.", "content": _CSS}},
        }
    }
