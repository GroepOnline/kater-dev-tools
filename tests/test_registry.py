...
def test_native_gateway_surface_is_twenty_four_without_extensions(monkeypatch) -> None:
    ...
    assert "kater_session_submit" in names
    assert "kater_session_events" in names
